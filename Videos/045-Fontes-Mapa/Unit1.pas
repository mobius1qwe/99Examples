...
type
  TForm1 = class(TForm)
    ...
    procedure img_normalClick(Sender: TObject);
    procedure img_sateliteClick(Sender: TObject);
  private
...
procedure TForm1.img_normalClick(Sender: TObject);
begin
        MapView1.MapType := TMapType.Normal;
...
procedure TForm1.img_sateliteClick(Sender: TObject);
begin
